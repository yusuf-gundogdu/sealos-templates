...
LibreDB Studio 是一款开源数据库 IDE，可直接在浏览器中查询和管理 PostgreSQL、MySQL、SQLite、MongoDB 等数据源。此模板会在 Sealos Cloud 上部署 LibreDB Studio 0.16.2，并配置 HTTPS 入口、持久化服务端存储、健康检查和部署时创建的管理员账号。
